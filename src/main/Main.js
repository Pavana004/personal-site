  ...
  return (
    <div className="main" id="home">
      <motion.div
        ...
        animate="animate"
      >
        <motion.h3 variants={textVariants} className="name">
          Hi I'm Pavan
        </motion.h3>
        <motion.h3 variants={textVariants} className="professional">
          {" "}
          {text}
          <span style={{ color: "rgba(176, 0, 32, 1)" }}>
            <Cursor />
          </span>{" "}
        </motion.h3>
        <motion.h3 variants={textVariants} className="country">
          Based In India.
        </motion.h3>
        <br />
        <motion.p variants={textVariants} className="shortDes">
